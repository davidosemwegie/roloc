...
The separate [public casual leaderboards](LEADERBOARDS.md) have their own submission switch and accept public guests. Public registration does not grant Daily access; only a valid invitation attaches the current closed-test epoch. Keep Daily paused independently when rolling out the casual boards.
