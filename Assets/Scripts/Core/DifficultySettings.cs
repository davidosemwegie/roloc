...
namespace Roloc.Core
{
    ...
    public sealed class DifficultySettings : ScriptableObject
    {
        ...
        [Header("Flow seconds per match")]
        [SerializeField, Min(0.1f)] private float flowInitialSeconds = 3.5f;
        [SerializeField, Min(1)] private int flowFirstThreshold = 10;
        [SerializeField, Min(0.1f)] private float flowFirstSeconds = 3f;
        [SerializeField, Min(1)] private int flowSecondThreshold = 25;
        [SerializeField, Min(0.1f)] private float flowSecondSeconds = 2.5f;
        [SerializeField, Min(1)] private int flowThirdThreshold = 50;
        [SerializeField, Min(0.1f)] private float flowThirdSeconds = 2.25f;
        ...
        public float GetFlowSeconds(int score)
        {
            if (score >= flowThirdThreshold) return flowThirdSeconds;
            if (score >= flowSecondThreshold) return flowSecondSeconds;
            if (score >= flowFirstThreshold) return flowFirstSeconds;
            return flowInitialSeconds;
        }
